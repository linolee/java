...
public class MultiChatServerView extends JFrame {
	...
	public MultiChatServerView() {
		...
		jspList1.setBorder(new TitledBorder("1조 접속자 정보"));
		jspList2.setBorder(new TitledBorder("2조 접속자 정보"));
		jspList3.setBorder(new TitledBorder("3조 접속자 정보"));
		jspList4.setBorder(new TitledBorder("4조 접속자 정보"));
